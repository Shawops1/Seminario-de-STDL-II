...
namespace analizadorLexico
{
    ...
    class Compilador
    {
        ...
        public void cargarMatriz()
        {
            ...
            String[] lineas = File.ReadAllLines(@"D:\Escuela\Semestre 2023 A\SEMINARIO DE SOLUCION DE PROBLEMAS DE TRADUCTORES DE LENGUAJES II\06\analizadorLexico\compilador.lr", Encoding.Default);
        ...
        public void cargarReglas()
        {
            int delimitador = 9;
            char _dem = Convert.ToChar(delimitador);
            string[] lineas = File.ReadAllLines(@"D:\Escuela\Semestre 2023 A\SEMINARIO DE SOLUCION DE PROBLEMAS DE TRADUCTORES DE LENGUAJES II\06\analizadorLexico\reglas.txt", Encoding.Default);
